...
import { ArrowLeftIcon } from 'react-native-heroicons/outline'; // hericons
...
export default function KundliAstro({ navigation }) {
      ...
      >
        ...
        >
          <View style={styles.outerContainer}>
            {/* Top Bar with Back Arrow and Kundli Text, left aligned and safe from notches */}
            <View style={styles.topBar}>
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <ArrowLeftIcon color="#4B2067" size={scale(26, SCREEN_WIDTH)} />
              </TouchableOpacity>
              <Text style={styles.topBarTitle}>Kundli</Text>
            </View>
...
function getStyles(SCREEN_WIDTH, SCREEN_HEIGHT) {
  return StyleSheet.create({
    ...
    //   paddingTop: verticalScale(6, SCREEN_HEIGHT),
      paddingBottom: verticalScale(6, SCREEN_HEIGHT),
    //   backgroundColor: '#000000',
    //   minHeight: verticalScale(44, SCREEN_HEIGHT),
      // The SafeAreaView already handles the notch, but extra padding can be added if needed
    },
    backButton: {
      padding: moderateScale(4, SCREEN_WIDTH),
      justifyContent: 'center',
      alignItems: 'center',
      marginRight: moderateScale(8, SCREEN_WIDTH),
    },
    topBarTitle: {
      fontSize: scale(20, SCREEN_WIDTH),
      fontWeight: 'bold',
      color: '#4B2067',
      letterSpacing: 1,
      textAlign: 'left',
      // No flex, so it stays left after the icon
    },
    bannerWrapper: {
      width: '100%',
      alignItems: 'center',
